from src.base.data import arrange, Rectangle
...
class Block(NSEExperiment):
    ...
    def __init__(
        ...
        for i in arrange(1.05, 1.95, .05):
            self._rim_facts.add((i, .5), u=0, v=0)
            self._rim_facts.add((i, 1.5), u=0, v=0)
        for i in arrange(.55, 1.45, .05):
            self._rim_facts.add((1, i), u=0, v=0)
            self._rim_facts.add((2, i), u=0, v=0)
        self._rim_facts.add((1, .5), u=0, v=0)
        self._rim_facts.add((1, 1.5), u=0, v=0)
        self._rim_facts.add((2, .5), u=0, v=0)
        self._rim_facts.add((2, 1.5), u=0, v=0)
